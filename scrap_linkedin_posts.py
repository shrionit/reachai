...
page = "https://www.linkedin.com/company/accenture/"
...
containers = [
    container
    for container in linkedin_soup.find_all("div", {"class": "feed-shared-update-v2"})
...
for container in containers:
    ...
    post_date = get_text(
        ...
        "span",
        {
            "class": "update-components-actor__sub-description t-black--light t-12 t-normal"
        },
    )
...
write_to_file("gpt_scrapped_data.json", json.dumps(posts_data))
